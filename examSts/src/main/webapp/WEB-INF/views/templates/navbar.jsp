...
<link href="${pageContext.request.contextPath}/resources/css/hosun.css" rel="stylesheet"/>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light customNav"> 
        <div class="navbar__logo">
            ...
            <span style="margin-left: 1em;">TMDB</span>
        </div>
        ...
        <ul class="navbar__menu css-member">
            <li class="nav-link active">
                ...
                <li class="nav-link active">
                    <a class="css-memberButton">로그인</a>
                    <a class="css-memberButton">회원가입</a>
                </li>
            </li>
        </ul>
    </nav>
